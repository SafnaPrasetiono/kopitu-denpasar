...
@section('head')
    <title>kopitu - Selemat datang di form login KOPITU Denpasar</title>
@endsection
...
@section('pages')
    <div class="box-auth">
        <div class="box-head">
            ...
            <p class="mb-0">Selamat datang di KOPITU Denpasar</p>
        </div>
        <div class="box-body">
            <form method="POST" action="#">
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <a href="{{ route('password.get') }}" class="link-orange text-decoration-none ms-auto me-1">Get Password?</a>
                </div>
        ...
        <div class="box-footer">
            ...
            <div class="d-block mb-4">
                <div class="d-flex justify-content-center align-items-center">
                    <a href="#" class="btn btn-outline-secondary align-items-center w-100">
