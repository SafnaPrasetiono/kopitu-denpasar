...
@section('head')
<title>kopitu denpasar - About kopitu denpasar</title>
<style>
    .elements-skew {
        top: 0;
        bottom: 0;
        ...
        <div class="container py-5">
            <div class="d-block mb-5 pb-5">
                <div class="row g-3 gx-4 align-items-center justify-content-center">
                    <div class="col-12 col-lg-6 order-2 order-lg-1">
                        <div>
                            <p class="fw-bold fs-3 mb-1">Our Vision</p>
                            <hr class="soft" style="width: 100px">
                            <p class="fs-5">Making it easier for MSMEs and MSMEs to deal with companies, both licensing and marketing</p>
                            <p class="fs-5">KOPITU has a vision to realize MSMEs to upgrade, go export and be independent.</p>
                        </div>
                    </div>
            ...
            <div class="d-block mb-4">
                <div class="row g-3 gx-4 align-items-center justify-content-center">
                    ...
                    <div class="col-12 col-lg-6">
                        <div>
                            <p class="fw-bold fs-3 mb-1">Our Mission</p>
                            <hr class="soft" style="width: 100px">
                            <ul class="fs-5 px-3">
                                <li>Entrepreneurship MSMEs to be more professional and characterful.</li>
                                <li>Strengthening networks and cooperation with the government and other stake holders to strengthen the role and cooperatives and MSMEs.</li>
                                <li>Assisting cooperatives and MSMEs in accessing the strengthening of business capital, human resources, technology, and domestic and global markets.</li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<div class="py-5">
    <div class="container pt-3 pb-5 py-lg-5">
        <div class="d-block text-center mb-5">
            <h3 class="fw-bold text-uppercase">CAREER JOURNEY</h3>
            <p class="fs-5">
                KOPITU invites various parties to improve domestic and foreign marketing. This aims to prosper MSMEs and SMEs which are included in the main wheel of economic turnover
            </p>
        </div>
                            ...
                            <div class="my-career card pb-4 border-0 rounded-0">
                                ...
                                <div class="py-3">
                                    ...
                                    <div class="text-center px-3">
                                        ...
                                        <p class="mb-0">The meeting with BPOM discussed cooperation for the management of pbom umk and MSMEs</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="my-career card pb-4 border-0 rounded-0">
                                ...
                                <div class="py-3">
                                    ...
                                    <div class="text-center px-3">
                                        ...
                                        <p class="mb-0">Making the first electronic store to make it easier for msmes and MSMEs</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="owl-item">
                            <div class="my-career card pb-4 border-0 rounded-0">
                                ...
                                <div class="py-3">
                                    ...
                                    <div class="text-center px-3">
                                        <p class="fw-bold fs-5 mb-1">2022</p>
                                        <p class="mb-0">Meeting with LKPP discusses integration with kopitu e-store</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="bg-blue-5 py-5 px-0 m-0">
    <div class="container pt-3 pb-5 py-lg-5">
        <div class="row g-3 align-items-stretch">
            <div class="col-12">
                <p class="fs-3 fw-bold">Our Location</p>
            </div>
