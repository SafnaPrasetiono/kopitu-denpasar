...
@section('head')
<title>kopitu - News Kopitu Denpasar</title>
    ...
    <div class="container">
        <div class="d-flex flex-column flex-lg-row align-items-lg-center">
            <div class="mb-3 mb-lg-0">
                <h3 class="fw-bold text-white">News</h3>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item text-light"><a href="#" class="link-light">Home</a></li>
                    <li class="breadcrumb-item text-light active" aria-current="page">News</li>
                </ol>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-lg-12">
                        <div class="list-group rounded-0 mb-4">
                            <a href="#" class="list-group-item py-3 active" aria-current="true">Latest News</a>
                            <a href="#" class="list-group-item py-3" aria-current="true">Tranding News</a>
                            <a href="#" class="list-group-item py-3" aria-current="true">Old News</a>
                            <a href="#" class="list-group-item py-3" aria-current="true">Training News</a>
                            <a href="#" class="list-group-item py-3" aria-current="true">All News</a>
                        </div>
                        <div class="d-block mb-3 border p-3">
                            <div class="d-block mb-3">
                                <span class="fw-bold">Search News By Date</span>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="" class="form-label">Until Date</label>
                                <input type="date" class="form-control">
                            </div>
                            <button class="btn btn-outline-primary form-control">SEARCH NEWS</button>
                        </div>
                    </div>
                </div>
            </div>
