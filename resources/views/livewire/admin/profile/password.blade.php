<div>
    <div class="container-fluid">
        <div class="d-flex flex-column flex-sm-row align-items-center justify-content-center bg-custom rounded-3 border shadow-sm p-3">
            <div class="p-3" style="width: 270px">
                <img src="{{ url('/images/wallpaper/password.png') }}" alt="" class="img-fluid">
            </div>
            <div class="ms-0 ms-md-4 flex-fill">
                <p class="fs-5 fw-bold text-primary">Change your password account</p>
                <p class="text-secondary mb-0">Your Account</p>
                <p class="mb-4 text-secondary">{{ auth('admin')->user()->email }}</p>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="mb-3 text-center py-3">
                        <img src="{{ url('/images/wallpaper/password.png') }}" alt="" class="img-fluid w-50 mb-3">
                ...
                <div class="modal-footer">
                    ...
                    <button wire:click='setup' type="button" class="btn btn-primary">Simpan</button>
                  </div>
            </div>
        </div>
    </div>
