    ...
    <div class="bg-custom-3 py-5">
        <div class="container">
            <div class="d-block rounded-3 shadow-sm bg-custom-4 py-5 text-center">
                <h3 class="text-blue-1">CHECK YOUR DATA</h3>
                <p class="fs-5 text-blue-2">Have registered for membership to check your data below here</p>
                ...
                <button wire:click='store' class="btn btn-outline-primary btn-lg px-5">CHECK DATA</button>
            </div>
        </div>
    </div>
