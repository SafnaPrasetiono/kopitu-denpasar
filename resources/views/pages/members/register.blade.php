...
@section('head')
<title>kopitu denpasar - Daftar keanggotaan kopitu denpasar</title>
<style>
    .foto-upload {
        position: relative;
        display: flex;
...
<div class="py-5 bg-blue-4">
    <div class="container">
        <h3 class="fw-bold">Form Pendaftaran Anggota</h3>
        <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item text-secondary"><a href="{{ route('index') }}" class="link-secondary text-decoration-none">beranda</a></li>
            <li class="breadcrumb-item text-secondary"><a href="{{ route('member') }}" class="link-secondary text-decoration-none">Keanggotaan</a></li>
            <li class="breadcrumb-item text-secondary active" aria-current="page">Daftar</li>
        </ol>
    </div>
</div>
<div class="py-4">
    <div class="container">
        <form action="#" method="POST" enctype="multipart/form-data">
            ...
            @livewire('pages.members.description')
